...
function InterfaceListItem({ interfacer, getUrl }: { interfacer: Interfacer; getUrl: GetUrl }) {
    return (
        <li className={styles.item}>
            <Link href={getUrl(interfacer)}>
                ...
                <div className={styles.item__bottom}>
                    <p className={styles.item__description}>{interfacer?.description}</p>
                    <p className={styles["item__last-updated"]}>Last updated {timeAgo(interfacer.build_time)}</p>
                </div>
            </Link>
        </li>
    );
