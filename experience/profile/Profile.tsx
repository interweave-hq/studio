    ...
    return (
        <main className={styles.wrapper}>
            ...
            <section className={styles.section}>
                ...
                <p className={styles.section__text}>This billing cycle, you&apos;re responsible for {user.billing_cycle_owned_requests} requests.</p>
                <p className={styles.section__text}>We send an invoice at the first of every month, your first month free.</p>
            </section>
            <section className={styles.section}>
                <h2 className={styles.section__title}>Request history</h2>
                <p className={styles.section__text}>
                    If an interface in one of your projects has the &quot;InterfaceOwner&quot; billing strategy enabled, you may see requests from other users
                    here.
                </p>
                <Table
                    columns={[
