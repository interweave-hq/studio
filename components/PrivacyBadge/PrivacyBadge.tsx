import { EyeSlash, Globe, HandRaised, LockClosed, UserGroup } from "@/components/Icons";
...
export type PrivacyBadgeOverrides<T> = InternalBadgeOverrides<T> & ExternalPrivacyBadgeOverrides<T>;

export type PrivacyValue = "Private" | "Unlisted" | "Public" | "DomainRestricted" | "InviteRestricted";
