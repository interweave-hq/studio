...
export type CheckboxOverrides<T> = InternalCheckboxOverrides<T> & ExternalCheckboxOverrides<T>;
...
const Checkbox = forwardRef<ChildRef, Props>((props, ref) => {
    ...
    const { description, domProps, helperText = "", label, register, __cssFor } = props;
    const id = useId();
    const {
        root: rootStyles,
        ...
        return shapeCss<OverridesKeys, CheckboxOverrides<string>>(Overrides, styles, __cssFor);
    }, [__cssFor]);
    return (
