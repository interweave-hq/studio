    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.footer__socials}>
                <a
                    href="https://x.com/InterweaveHQ"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles["footer__icon-link"]}
                    aria-label="Visit the Interweave profile on X"
                >
                    <svg
                        viewBox="0 0 1200 1227"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className={`${styles["footer__icon"]} ${styles["footer__icon--x"]}`}
                    >
                        <path
                ...
                <a
                    href="https://twitter.com/InterweaveHQ"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles["footer__icon-link"]}
                    aria-label="Visit the Interweave profile on Twitter"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                ...
                <a
                    ...
                    rel="noopener noreferrer"
                    className={styles["footer__icon-link"]}
                    aria-label="Join the Interweave Discord"
                >
                    <svg
                        className={styles["footer__icon"]}
